    ...
    <div class="container-create-product--form_control">
        <div class="container-create-product--form_input container-form">
            ...
            <div>
                ...
                <div>
                    <input id="price-tea" type="number" step="0.01"
        ...
        <div>
            <div class="dragger-wrapper">
                <div id="dragger-tea" class="dragger-wrapper--drag">
                    <div id="container_input-tea">
                        <label for="image" class="form-label"><i class="fa-solid fa-images"></i></label>
                        <button type="button" class="btn btn-secondary" onclick="browseFileHandlerTea()">Browser
                            file</button>
                    </div>
                    <input id="image-tea" type="file" hidden
                ...
                <div id="filename-tea" class="filename-class"></div>
            </div>
        </div>
    </div>
